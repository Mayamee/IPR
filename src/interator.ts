...
interface Aggregator<T> {
  ...
  getCustomIterator(): CustomIterator<T>;
}
...
class AlphabeticalOrderCustomIterator implements CustomIterator<string> {
...
class WordsCollection implements Aggregator<string> {
  ...
  public getCustomIterator(): CustomIterator<string> {
    return new AlphabeticalOrderCustomIterator(this);
  }

  public getReverseCustomIterator(): CustomIterator<string> {
    return new AlphabeticalOrderCustomIterator(this, true);
  }
}
...
const iterator = collection.getCustomIterator();
...
const reverseCustomIterator = collection.getReverseCustomIterator();
while (reverseCustomIterator.valid()) {
  console.log(reverseCustomIterator.next());
}
